...
//	Simple delay loop, to prevent this function from breaking sometimes, have no idea why it was breaking.
//	It doesn't break on a PC with less RAM and a slower CPU
	int z = 100;
	while(z != 0){
		z--;
	}
